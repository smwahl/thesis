...
low as 0.05. In 6 Earth-mass case the adiabat through the low pressure part of the planet is
also below a typical mantle solidus, meaning that a single planet might contain an
outer rocky mantle, a deep magma ocean, followed by a deeper silicate-iron mixed
region. This is in contrast to the 1 Earth-mass case, where $\eta=0.15$ would require
most of the planet to be molten. For this reason, the mixed region on a 6
Earth-mass rocky planet may be long-lived, whereas such conditions could have only
existed for the earliest part of the Earth's evolution.
