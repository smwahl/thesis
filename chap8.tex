...
\begin{figure}[h]
  \begin{center}
    \noindent\includegraphics[width=20pc]{figs/jplot.pdf}
  \end{center}
...
\caption{ {\footnotesize Zonal gravitational moments $J_4$ and $J_6$ for interior models
...
%\setfigurenum{S1} %%Change number for each figure
\includegraphics[width=22pc]{figs/he_rainlayer_j4j6.png}
